...
if (is_array($orderArr) && count($orderArr) > 0) {
    foreach ($orderArr as $vid) {
        ...
        <?php } else if ($item->type == 'picture_text') { ?>
        <!-- right text -->
        ...
        <?php } else if ($item->type == 'video_text') { ?>
            <!-- right text -->
            <?php if ($item->options == 'right_text') { ?>
            ...
            <?php } ?>
        <?php } else if ($item->type == '2_blocks') { ?>
            <section class="land__block">
                <div class="land__fixed">
        ...
        <?php } else if ($item->type == '3_blocks') { ?>
            <section class="land__block">
                <div class="land__fixed">
        ...
        <?php } else if ($item->type == '4_blocks') { ?>
            <section class="land__grey-block">
                <div class="land__fixed">
        ...
        <?php } else if ($item->type == 'contact_us') { ?>
                ...
                <?php } ?>
        <?php } else if ($item->type == 'how_it_work') { ?>
            <section class="land__block">
                <div class="land__fixed">
