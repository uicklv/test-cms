...
<h3 class="title-popup">Request Further Info</h3>
<form id="apply_form" class="popup-form">
    ...
    <button class="btn-yellow" type="submit" onclick="load('request-info/<?= $this->profile->id; ?>', 'form:#apply_form'); return false;">SUBMIT</button>
</form>
