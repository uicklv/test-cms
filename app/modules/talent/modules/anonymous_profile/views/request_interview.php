...
<h3 class="title-popup">Request Interview</h3>
<form id="apply_form" class="popup-form">
    ...
    <button class="btn-yellow" type="submit" onclick="load('request-interview/<?= $this->profile->id; ?>', 'form:#apply_form'); return false;">SUBMIT</button>
</form>
