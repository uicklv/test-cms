...
<h3 class="title-popup">Book for Contract</h3>
<form id="apply_form" class="popup-form">
    ...
    <button class="btn-yellow" type="submit" onclick="load('open-book/<?= $this->profile->id; ?>', 'form:#apply_form'); return false;">SUBMIT</button>
</form>
