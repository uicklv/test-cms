<section class="section-inner" style="margin-top: 200px;">
    <div class="fixed">
        <div class="account-reg mar">
            <div class="ar-right">
                <h3 class="title-small">Learning & Development Login</h3>
                <form id="form_login" class="log-form">
                    ...
                    <div class="fs-flex fs-flex-sub">
                        ...
                        <button class="more-link" type="submit" onclick="load('learning_development/login', 'form:#form_login'); return false;">Login</button>
                    </div>
                </form>
            </div>
        </div>
