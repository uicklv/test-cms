...
<form id="form_box" action="{URL:panel/blog/statistic/<?= $this->blog->id; ?>}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="items_group items_group-wrap items_group-bottom">
                            <div class="items_left-side">
                                <div class="option-btns-list scroll-list">
                                    <a href="{URL:panel/blog/edit/<?= $this->blog->id; ?>}" class="btn btn-rectangle_medium"><i class="bs-tooltip fa fa-pencil-alt"></i>Edit</a>
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="flex-btw flex-vc mob_fc">
                        <h4>Referrals: </h4>
                        <div>
                            <a class="btn btn-primary mb-2 mr-2" href="{URL:panel/blog/add_ref/<?= $this->blog->id; ?>}">
                                ...
                                <?php foreach ($this->referrals as $item) { ?>
                                    <tr>
                                        ...
                                        <td class="option__buttons">
                                           <a href="{URL:panel/blog/delete_ref/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
