        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6" >
                ...
                <div class="flex-start">
                    <span class="mr-3"><a class="pointer" onclick="load('panel/blog/filter')">All</a></span>
                    <?php if ($this->categories) { ?>
                        <?php foreach ($this->categories as $category) {?>
                            <span class="mr-3"><a class="pointer" onclick="load('panel/blog/filter', 'category=<?= $category->id ?>')"><?= $category->name ?></a></span>
                        <?php } ?>
                    <?php } ?>
                </div>
