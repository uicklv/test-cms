<form id="form_box" action="{URL:panel/blogtest/edit/<?= $this->blog->id; ?>}" method="post" enctype="multipart/form-data">
        ...
        <div class="row layout-top-spacing">
            ...
            <div class="flex-btw">
                ...
                <div class="option__buttons">
                    ...
                    <a href="{URL:panel/blogtest/statistic/<?= $this->blog->id; ?>}" class="bs-tooltip fa fa-chart-bar" title="Statistic"></a>
                </div>
            </div>
            </div>
            */ ?>
                        ...
                        <div class="items_group items_group-wrap">
                            <div class="items_left-side">
                                <div class="title-block">
                                    <a class="btn-ellipse bs-tooltip fas fa-rss" href="{URL:panel/blogtest}"></a>
                            ...
                            <div class="items_right-side">
                                ...
                                <a class="btn btn-outline-warning" href="{URL:panel/blogtest}"><i class="fas fa-reply"></i>Back</a>
                            </div>
                        </div>
                        ...
                        <div class="items_group items_group-wrap items_group-bottom">
                            <div class="items_left-side">
                                <div class="option-btns-list scroll-list">
                                    ...
                                    <a href="{URL:panel/blogtest/statistic/<?= $this->blog->id; ?>}" class="btn btn-rectangle_medium" title="Statistic"><i class="bs-tooltip fa fa-chart-bar"></i>Statistic</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="flFormsGrid" class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <div class="form-control" name="content" id="text_content"></div>
                    </div>
                </div>
            </div>
                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header widget-bottom">
                        ...
                        <a class="btn btn-success" onclick="
                                setTextareaValue();
                                load('panel/blogtest/edit/<?= $this->blog->id; ?>', 'form:#form_box'); return false;">
...
<script>
    ...
    $(function () {
        ...
        quill.setContents(<?= htmlspecialchars_decode(post('content', false, $this->blog->content)); ?>);
    });
