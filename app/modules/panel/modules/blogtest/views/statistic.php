...
<form id="form_box" action="{URL:panel/blogtest/statistic/<?= $this->blog->id; ?>}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="items_group items_group-wrap items_group-bottom">
                            <div class="items_left-side">
                                <div class="option-btns-list scroll-list">
                                    <a href="{URL:panel/blogtest/edit/<?= $this->blog->id; ?>}" class="btn btn-rectangle_medium"><i class="bs-tooltip fa fa-pencil-alt"></i>Edit</a>
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="flex-btw flex-vc mob_fc">
                        <h4>Referrals: </h4>
                        <div>
                            <a class="btn btn-primary mb-2 mr-2" href="{URL:panel/blogtest/add_ref/<?= $this->blog->id; ?>}">
                            ...
                            <?php if (isset($this->referrals) && is_array($this->referrals) && count($this->referrals)) { ?>
                                <?php foreach ($this->referrals as $item) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn btn-copy btn-info" data-link="<?= SITE_URL ?>blog/<?= $this->blog->slug; ?>?ref=<?= $item->title; ?>" onclick="copyClipboard(this);">copy link</div>
                                        </td>
                                        <td>
                                            <?= $this->refArray[$item->title] ?: 0 ?>
                                        </td>
                                        <td class="option__buttons">
                                           <a href="{URL:panel/blogtest/delete_ref/<?= $item->id; ?>}" class="bs-tooltip fa fa-trash" title="Delete"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
