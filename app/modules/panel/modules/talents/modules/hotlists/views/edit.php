                        ...
                        <div class="items_group items_group-wrap">
                            <div class="items_left-side">
                                <div class="title-block">
                                    <a class="btn-ellipse bs-tooltip fa fa-list" href="{URL:panel/talents/hotlists}"></a>
                            ...
                            <div class="items_right-side hide_block1024">
                                ...
                                <a class="btn btn-outline-warning" href="{URL:panel/talents/hotlists}"><i class="fas fa-reply"></i>Back</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="form-group col-md-6">
                        <label>Anonymous profiles to add to hot-list (Check the ones you'd like to add)</label>
                        <input type="text" class="form-control" id="anon_filter" value="" autocomplete="off" placeholder="Start typing to filter profiles below">
                            ...
                            <?php if (isset($this->anonymous) && is_array($this->anonymous) && count($this->anonymous) > 0) { ?>
                                <?php foreach ($this->anonymous as $item) { ?>
                                    <div class="custom-control custom-checkbox checkbox-info">
                                        ...
                                        <label class="custom-control-label anons" for="anonymous_<?=$item->id?>"><?= $item->job_title; ?></label>
                                    </div>
                                <?php } ?>
                            <?php } ?>
                        </div>
                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header widget-bottom">
                        ...
                        <a class="btn btn-success"
                           onclick="setTextareaValue(); load('panel/talents/hotlists/edit/<?= $this->list->id; ?>', 'form:#form_box'); return false;">
...
<script>
    $('#anon_filter').keyup(function () {
        var q = $(this).val().toLowerCase().trim();

        if (q.length > 0) {
            $('.anons').each(function (i, list) {
