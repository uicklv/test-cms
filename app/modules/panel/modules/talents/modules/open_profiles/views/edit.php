...
<form id="form_box" action="{URL:panel/talents/open_profiles/edit/<?= $this->user->id; ?>}" method="post" enctype="multipart/form-data">
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing">
                        ...
                        <div class="items_group items_group-wrap">
                            <div class="items_left-side">
                                <div class="title-block">
                                    <a class="btn-ellipse bs-tooltip fa fa-address-card" href="{URL:panel/talents/open_profiles}"></a>
                                    <h1 class="page_title"><?= $this->user->candidate_name ?></h1>
                                </div>
                            </div>
                            ...
                            <div class="items_right-side hide_block1024">
                                ...
                                <a class="btn btn-outline-warning" href="{URL:panel/talents/open_profiles}"><i class="fas fa-reply"></i>Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" type="text" name="candidate_name" id="candidate_name" value="<?= post('candidate_name', false, $this->user->candidate_name); ?>"><!--required-->
                        </div>
                    </div>
            ...
            <div class="col-lg-12 layout-spacing">
                <div class="statbox widget box box-shadow">
                    <h4>CV / Resume info</h4>
                    <div class="form-group">
                        <textarea class="form-control" name="resume_info" id="resume_info" rows="20"><?= post('resume_info', false, $this->user->resume_info); ?></textarea>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="choose-file modern">
                                ...
                                <div id="preview_image" class="preview_image">
                                    <img src="<?= _SITEDIR_ ?>data/talent/open_profiles/<?= post('image', false, $this->user->image); ?>" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <!-- File -->
                            <label for="file">CV File
                                <?= ($this->user->cv ? '<a href="'. _SITEDIR_ .'data/talent/open_profiles/' . $this->user->cv . '" download="file.' . File::format($this->user->cv ) . '"><i class="fas fa-download"></i> Download</a>' : '') ?>
                            </label>
                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header widget-bottom">
                        ...
                        <a class="btn btn-success"
                           onclick="setTextareaValue(); load('panel/talents/open_profiles/edit/<?= $this->user->id; ?>', 'form:#form_box'); return false;">
...
<script>
    ...
    function setTextareaValue() {
        ...
        $('#resume_info').val(editorField2.getData());
    }
    ...
    $(function () {
        ...
        editorField2 = CKEDITOR.replace('resume_info', {
            htmlEncodeOutput: false,
            wordcount: {
                showWordCount: true,
                showCharCount: true,
