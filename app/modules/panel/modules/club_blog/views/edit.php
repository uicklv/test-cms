<form id="form_box" action="{URL:panel/club_blog/edit/<?= $this->blog->id; ?>}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="items_group items_group-wrap">
                            <div class="items_left-side">
                                <div class="title-block">
                                    <a class="btn-ellipse bs-tooltip fa fa-lock" href="{URL:panel/club_blog}"></a>
                            ...
                            <div class="items_right-side">
                                <div class="items_small-block">
                                    <a href="{URL:members-growth-club/article/<?= $this->blog->slug; ?>}" class="btn-rectangle bs-tooltip fa fa-eye" title="View Article" target="_blank"></a>
                        ...
                        <div class="items_group items_group-wrap items_group-bottom">
                            <div class="items_left-side">
                                <div class="option-btns-list scroll-list">
                                    ...
                                    <a href="{URL:panel/club_blog/views/<?= $this->blog->id; ?>}" class="btn btn-rectangle_medium" title="Statistic"><i class="bs-tooltip fa fa-chart-bar"></i>Statistic</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="choose-file modern">
                                ...
                                <div id="preview_image" class="preview_image">
                                    <img src="<?= _SITEDIR_ ?>data/club_blog/<?= post('image', false, $this->blog->image); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header widget-bottom">
                        ...
                        <a class="btn btn-success" onclick="
                                setTextareaValue();
                                load('panel/club_blog/edit/<?= $this->blog->id; ?>', 'form:#form_box'); return false;">
