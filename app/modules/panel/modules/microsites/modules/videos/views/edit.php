<form id="form_box" action="{URL:panel/microsites/videos/edit/<?= $this->edit->id; ?>}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="items_group items_group-wrap">
                            <div class="items_left-side">
                                <div class="title-block">
                                    <a class="btn-ellipse bs-tooltip fa fa-video" href="{URL:panel/microsites/videos/index/<?= $this->edit->microsite_id; ?>}"></a>
                            ...
                            <div class="items_right-side hide_block1024">
                                ...
                                <a class="btn btn-outline-warning" href="{URL:panel/microsites/videos/index/<?= $this->edit->microsite_id; ?>}"><i class="fas fa-reply"></i>Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group">
                                <label for="file">Video
                                    ...
                                    <?= ($this->edit->video ? '<a href="'. _SITEDIR_ .'/data/microsites/videos/' . $this->edit->video . '" download="' . $this->edit->name . '.' . File::format($this->edit->video) . '"><i class="fas fa-download"></i> Download</a>' : '') ?>
                                </label>

                                <div class="flex flex-vc">
                                    <div class="choose-file">
                                        <input type="hidden" name="file" id="file" value="<?= post('file', false, $this->edit->video); ?>">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="choose-file modern">
                                ...
                                <div id="preview_image" class="preview_image">
                                    <img src="<?= _SITEDIR_ ?>data/microsites/videos/<?= post('image', false, $this->edit->image); ?>" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing sticky-block-bottom">
                <div class="statbox widget box box-shadow">
                    <div class="widget-header widget-bottom">
                        <a class="btn btn-outline-warning" href="{URL:panel/microsites/videos/index/<?= $this->edit->microsite_id ?>}"><i class="fas fa-reply"></i>Back</a>
                        <a class="btn btn-success" onclick="load('panel/microsites/videos/edit/<?= $this->edit->id; ?>', 'form:#form_box'); return false;">
