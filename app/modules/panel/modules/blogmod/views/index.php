            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="flex-btw flex-vc mob_fc">
                    ...
                    */ ?>
                    ...
                    <h1>Blog Posts</h1>
                    <div>
                        <a class="btn btn-primary mb-2 mr-2" href="{URL:panel/blogmod/archive}">
                            <i class="fas fa-archive mp768_0"></i>
                            Archived
                        </a>
                        <a class="btn btn-primary mb-2 mr-2" href="{URL:panel/blogmod/add}">
                        ...
                        <?php if (isset($this->list) && is_array($this->list) && count($this->list)) { ?>
                            <?php foreach ($this->list as $item) { ?>
                                <tr id="item_<?= $item->id; ?>" class="tr-hovered">
                                    ...
                                    <td>
                                        <a href="{URL:panel/blogmod/edit/<?= $item->id; ?>}"><?= $item->title; ?></a>
                                    </td>
                                    <td>
                                        <?= $item->views; ?>
                                    </td>
                                        ...
                                        <div class="items-row align-items-center">
                                            <div class="dropdown dropup custom-dropdown-icon">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink-3">
                                                    <a href="{URL:panel/blogmod/edit/<?= $item->id; ?>}" class="dropdown-item"><i class="fa fa-pencil-alt"></i> Edit</a>
                                                    <a href="{URL:blog/<?= $item->slug; ?>}" class="dropdown-item" target="_blank"><i class="fa fa-eye"></i> View Blog</a>
                                                    <a href="{URL:panel/blogmod/statistic/<?= $item->id; ?>}" class="dropdown-item"><i class="fa fa-chart-bar"></i> Statistic</a>
                                                    <a @click="load('panel/blogmod/delete/<?= $item->id; ?>');" class="dropdown-item remove-item"><i class="fa fa-trash-alt"></i> Delete test</a>
                                                </div>
                                            </div>
