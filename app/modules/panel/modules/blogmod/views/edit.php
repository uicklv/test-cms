<form id="form_box" action="{URL:panel/blogmod/edit/<?= $this->blog->id; ?>}" method="post" enctype="multipart/form-data">
        ...
        <div class="row layout-top-spacing">
            ...
            <div class="flex-btw">
                ...
                <div class="option__buttons">
                    ...
                    <a href="{URL:panel/blogmod/statistic/<?= $this->blog->id; ?>}" class="bs-tooltip fa fa-chart-bar" title="Statistic"></a>
                </div>
            </div>
            </div>
            */ ?>
                        ...
                        <div class="items_group items_group-wrap">
                            <div class="items_left-side">
                                <div class="title-block">
                                    <a class="btn-ellipse bs-tooltip fas fa-rss" href="{URL:panel/blogmod}"></a>
                            ...
                            <div class="items_right-side">
                                ...
                                <a class="btn btn-outline-warning" href="{URL:panel/blogmod}"><i class="fas fa-reply"></i>Back</a>
                            </div>
                        </div>
                        ...
                        <div class="items_group items_group-wrap items_group-bottom">
                            <div class="items_left-side">
                                <div class="option-btns-list scroll-list">
                                    ...
                                    <a href="{URL:panel/blogmod/statistic/<?= $this->blog->id; ?>}" class="btn btn-rectangle_medium" title="Statistic"><i class="bs-tooltip fa fa-chart-bar"></i>Statistic</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="statbox widget box box-shadow">
                    <div class="widget-header widget-bottom">
                        ...
                        <a class="btn btn-success" onclick="
                                setTextareaValue();
                                load('panel/blogmod/edit/<?= $this->blog->id; ?>', 'form:#form_box'); return false;">
...
<script src="https://cdn.tiny.cloud/1/1fa1fpr5tl9a6jcidbb27bi0sjosk5fnvcda71y5obdcun8h/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
...
<script>
    $(function () {
        ...
        tinymce.init({
            ...
            menubar: false,
            plugins: [
                'lists', 'link', 'image', 'code', 'fullscreen', 'table', 'charmap', 'advlist', 'wordcount', 'textcolor',
            ],
            toolbar: 'code | undo redo | bold italic underline | removeformat | numlist bullist checklist | ' +
                ' blockquote | link unlink | image table charmap | blocks | ' +
                'forecolor | alignleft aligncenter alignright alignjustify | a11ycheck | fullscreen',
            branding: true,
            init_instance_callback: function (editor) {
                $(editor.getContainer()).find('button.tox-statusbar__wordcount').click();
            },
            images_upload_url: '<?= _SITEDIR_ ?>public/plugins/kcfinder/postAcceptor.php',
        });
    });

    function setTextareaValue() {
        $('#text_content').val(tinymce.get("text_content").getContent());
    }
</script>
