<?php Popup::head('Change Title'); ?>
    ...
    <form id="field_form" class="ppsec" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-12">
                <a class="btn btn-success" href="" onclick="setTextareaValue(); load('panel/forms/change_field_title/<?= $this->field->id ?>/<?= $this->form_id ?>', 'form:#field_form'); return false;">
                    Add
                </a>
