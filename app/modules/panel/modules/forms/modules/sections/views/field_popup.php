<?php Popup::head('Add New Field'); ?>
    ...
    <form id="field_form" class="ppsec" method="post" enctype="multipart/form-data">
        <div class="form-row">
            ...
            <div class="form-group col-md-12">
                <a class="btn btn-success" href="" onclick="load('panel/forms/sections/field_popup/<?= $this->section->id ?>', 'form:#field_form', 'action_type=list'); return false;">
                    Add
                </a>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-12">
                <a class="btn btn-success" href="" onclick="setTextareaValue(); load('panel/forms/sections/field_popup/<?= $this->section->id ?>', 'form:#field_form', 'action_type=new'); return false;">
                    Add
                </a>
