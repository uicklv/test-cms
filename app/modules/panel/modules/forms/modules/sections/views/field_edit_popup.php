<?php Popup::head('Edit Field'); ?>
    ...
    <form id="field_form" class="ppsec" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-12">
                <a class="btn btn-success" href="" onclick="setTextareaValue(); load('panel/forms/sections/field_edit_popup/<?= $this->field->id ?>/<?= $this->section->id ?>', 'form:#field_form'); return false;">
                    Add
                </a>
