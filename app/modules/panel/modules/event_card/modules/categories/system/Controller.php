    ...
    public function addAction()
    {
        if ($this->startValidation()) {
            ...
            if ($this->isValid()) {
                ...
                $result   = Model::insert('events_categories', $data); // Insert row
                $insertID = Model::insertID();

                if (!$result && $insertID) {
                    Request::addResponse('redirect', false, url('panel', 'event_card', 'categories', 'edit', $insertID));
                } else {
    ...
    public function editAction()
    {
        ...
        if ($this->startValidation()) {
            ...
            if ($this->isValid()) {
                ...
                $result = Model::update('events_categories', $data, "`id` = '$id'"); // Update row
