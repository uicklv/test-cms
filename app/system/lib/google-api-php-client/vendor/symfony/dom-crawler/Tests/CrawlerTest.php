...
EOF
    ...
    public function testFilterXPathWithAnUrl()
    {
        ...
        $crawler = $crawler->filterXPath('//media:category[@scheme="http://gdata.youtube.com/schemas/2007/club_categories.cat"]');
    ...
    protected function createTestXmlCrawler($uri = null)
    {
        $xml = '<?xml version="1.0" encoding="UTF-8"?>
            <entry xmlns="http://www.w3.org/2005/Atom" xmlns:media="http://search.yahoo.com/mrss/" xmlns:yt="http://gdata.youtube.com/schemas/2007">
                ...
                <media:category label="Music" scheme="http://gdata.youtube.com/schemas/2007/club_categories.cat">Music</media:category>
            </entry>';
