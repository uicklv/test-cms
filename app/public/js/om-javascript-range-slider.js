...
function OmRangeSlider(inputElement, inputValueStyle) {
    ...
    function initVisuals() {
        ...
        settings.unit = (_input$getAttribute = input.getAttribute('unit')) !== null && _input$getAttribute !== void 0 ? _input$getAttribute : '';
        input.type = 'hidden';
...
function SliderEventHelper(buttonStart, buttonEnd) {
    ...
    function handleButtonGrabbed(e) {
        var _buttonStart$getBound, _buttonStart$getBound2, _buttonEnd$getBoundin, _buttonEnd$getBoundin2;

        e.preventDefault();
        isMouseButtonDown = true; // The touch area of the buttons are bigger than they are visually. Because of that, the touch area overlaps, in case that the buttons are positioned
        ...
        const buttonStartPosStart = (_buttonStart$getBound = (_buttonStart$getBound2 = buttonStart.getBoundingClientRect()) === null || _buttonStart$getBound2 === void 0 ? void 0 : _buttonStart$getBound2.left) !== null && _buttonStart$getBound !== void 0 ? _buttonStart$getBound : undefined;
        const buttonEndPosStart = (_buttonEnd$getBoundin = (_buttonEnd$getBoundin2 = buttonEnd.getBoundingClientRect()) === null || _buttonEnd$getBoundin2 === void 0 ? void 0 : _buttonEnd$getBoundin2.left) !== null && _buttonEnd$getBoundin !== void 0 ? _buttonEnd$getBoundin : undefined;
