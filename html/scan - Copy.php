...
// Project name
//define('CONF_PROJECT', 'parcll-ec9af2ab437b3c451772e2453886d7a6');
define('CONF_PROJECT', 'shoes-d9c9477451b84afa91da5fee9a1c6ec3');
...
foreach ($scanned as $item) {
    ...
    if (preg_match('/^([a-z0-9.-]+\.html)\s*/im', $item))
        $files[] = $item;
